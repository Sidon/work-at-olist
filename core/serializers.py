...
class CategorySerializer(serializers.ModelSerializer):
    subcategories = RecursiveField(source="get_children", many=True)
    ...
    def get_parent_instance(self, obj):
        ...
        if obj.parent:
            ...
            rtrn = reverse('category-detail', kwargs={'uuid': obj.parent.uuid}, request=request)
